...
const Header = () => {
  ...
  const navmenu = <>
      ...
      {
        user && <li><NavLink to="/userprofile"><button title={user?.displayName} className="bg-accent hover:bg-accent-focus py-3 uppercase text-white rounded-md px-5">Profile</button></NavLink></li>
      }
  </>;
